<?php
	...
	require_once('include/deleteActorForm.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="main">
		...
		<div class="content">
			...
			?>
					<h4>¿Vas a eliminar a un actor o una actriz?</h4>
					<?php
						$formularioBorradoActor = new formularioBorradoActor("deleteActor", array('action' => 'borraActor.php'));
						$formularioBorradoActor->gestiona()
					?>
			<?php
				}
			?>

<?php
	...
	require_once('include/insertActorForm.php');
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="main">
		...
		<div class="content">
			...
			?>
					...
					<?php $formularioInsercionActor = new formularioInsercionActor("insercionActor", array( 'action' => 'insertaActor.php'));
						$formularioInsercionActor->gestiona();
					?>
			<?php
				}
			?>
